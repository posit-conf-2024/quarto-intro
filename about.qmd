...
These materials are for a one-day workshop taking place before [posit::conf 2024](https://posit.co/conference/) in Seattle, Washington.

- [Location:]{.smallcaps} Hyatt Regency
- [Time:]{.smallcaps} 9 am - 5 pm August 12^th^
...
This source code and license for all of the materials found on this website can be found on Github [{{< fa brands github >}}](https://github.com/posit-conf-2024/intro-quarto).
